...
public interface SysDeptMapper extends BaseMapper<SysDept> {
    ...
    @DataScope(type = DataScopeType.PLATFORM, findInSet = true, tableAlias = "d",skipAdmin = false)
    ...
    /**
     * 根据ID查询同层所有子部门、本层所有子部门
     * @param deptId
     * @return
     */
    List<SysDept> selectPeerAndChildrenDeptById(Long deptId);
