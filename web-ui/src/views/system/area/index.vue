<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="areaName" label="区域名称" width="260"></el-table-column>
...
<script>
import {addArea, delArea, getArea, listArea, listAreaExcludeChild, updateArea} from "@/api/system/area";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除名称为"' + row.areaName + '"的数据项？').then(function () {
