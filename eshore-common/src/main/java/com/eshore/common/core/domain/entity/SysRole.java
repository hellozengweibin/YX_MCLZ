 ...
 * @author eshore
 */
@ApiModel(value = "SysRole", description = "角色表实体类")
@ToString
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class SysRole extends BaseEntity {
     ...
     */
    @ApiModelProperty(name = "菜单树选择项是否关联显示")
    private boolean menuCheckStrictly;

    /**
     * 部门树选择项是否关联显示（0：父子不互相关联显示 1：父子互相关联显示 ）
     */
    @ApiModelProperty(name = "部门树选择项是否关联显示")
    ...
    /**
     * 平台类型 1:数据决策系统 2:防溺水预警平台 3:智能云广播系统 4:运维管理系统 5:移动端
     */
    @Getter
    @Setter
