...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * 获取指定年月的最小日期
     *
     * @param yearMonthStr 格式yyyy-MM
     * @return
     */
    public static Date getMonthFirstDayOf(String yearMonthStr) {
        if (yearMonthStr == null) return new Date();
     ...
     * @return
     */
    public static Date getMonthLastDayOf(String yearMonthStr) {
        if (yearMonthStr == null) return new Date();
        String[] split = yearMonthStr.split("-");
        int year = Integer.parseInt(split[0]);
