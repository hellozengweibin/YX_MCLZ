package com.eshore.common.utils.poi;
...
import com.eshore.common.exception.UtilException;
import com.eshore.common.utils.DateUtils;
import com.eshore.common.utils.DictUtils;
import com.eshore.common.utils.StringUtils;
import com.eshore.common.utils.file.FileTypeUtils;
import com.eshore.common.utils.file.FileUtils;
import com.eshore.common.utils.file.ImageUtils;
...
public class ExcelUtil<T> {
    ...
    public CommonResult<?> exportExcel() {
        ...
        try {
            ...
            wb.write(out);
            return ResponseGenerator.genSuccessResult(filename);
        } catch (Exception e) {
            log.error("导出Excel异常{}", e.getMessage());
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = EshoreConfig.getDownloadPath() + filename;
